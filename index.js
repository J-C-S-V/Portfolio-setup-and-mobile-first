...
<ul class="modal-card__list">
  <li class="modal-card__canopy">CANOPY</li>
...
<img class="modal-card__img" src="./img/Snapshoot Portfolio.png" alt="" />
<p class="modal-card__p">
  Lorem, ipsum dolor sit amet consectetur adipisicing elit. Corrupti vitae
  placeat saepe vero delectus magni alias adipisci debitis iusto maiores
  architecto asperiores eveniet temporibus nulla, neque aliquid! Est,
  dignissimos cumque!
</p>
<ul class="modal-card__lits-2">
  <li class="modal-card__html modal-card__li">html</li>
  <li class="modal-card__css modal-card__li">css</li>
  <li class="modal-card__javascript modal-card__li">javascript</li>
</ul>
